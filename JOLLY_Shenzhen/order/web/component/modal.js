...
//             total_price: settleaccountsvm.total_price
//         }
//     },
...
//         '                   <h5>当前￥{{total_price}}</h5>\n' +
//         '                   <h5>折扣￥{{total_price}}</h5>\n' +
//         '                </div>\n' +
...
//         '                        <button class="btn btn-info py-2 px-4 w-100" onclick="getDiscountToCalculation({{item}})"><h5>{{item}}</h5></button>\n' +
//         '                    </div>\n' +
//         '                </div>\n' +
//         '            </div>\n' +
//         // '            <div class="modal-footer">\n' +
