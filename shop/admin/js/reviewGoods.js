...
$(document).ready(function () {
    reviewVM.goodsInfo = JSON.parse(sessionStorage.getItem('reviewGoods'))
    getReview(reviewVM.goodsInfo.item_id, reviewVM.goodsInfo.review_id)
})

function getReview(item_id, review_id) {
    reviewVM.pageList = []
    reviewVM.reviewList = []
