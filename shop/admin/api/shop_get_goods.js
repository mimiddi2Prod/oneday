        ...
        try {
            ...
            if (param['state'] == -1) {
                if (param['need_integral'] == 0) {
                    sql = "select count(id) from `item` where integral_price = ?";
                ...
                // 全部拉取
                if (param['need_integral'] == 0) {
                    sql = "select id,`name`,image,url,qcl,price,`describe`,`type`,integral_price,sort,state,specification_id_1,specification_id_2,category_id_1,category_id_2,category_id_3,create_time,brand_id,review_id,goods_info from item where integral_price = ? ORDER BY create_time desc limit ?,?";
                } else if (param['need_integral'] == 1) {
                    sql = "select id,`name`,image,url,qcl,price,`describe`,`type`,integral_price,sort,state,specification_id_1,specification_id_2,category_id_1,category_id_2,category_id_3,create_time,brand_id,review_id,goods_info from item where integral_price > ? ORDER BY create_time desc limit ?,?";
                }
                ...
                if (param['need_integral'] == 0) {
                    sql = "select id,`name`,image,url,qcl,price,`describe`,`type`,integral_price,sort,state,specification_id_1,specification_id_2,category_id_1,category_id_2,category_id_3,create_time,brand_id,review_id,goods_info from item where integral_price = ? and state = ? ORDER BY create_time desc limit ?,?";
                } else if (param['need_integral'] == 1) {
                    sql = "select id,`name`,image,url,qcl,price,`describe`,`type`,integral_price,sort,state,specification_id_1,specification_id_2,category_id_1,category_id_2,category_id_3,create_time,brand_id,review_id,goods_info from item where integral_price > ? and state = ? ORDER BY create_time desc limit ?,?";
                }
